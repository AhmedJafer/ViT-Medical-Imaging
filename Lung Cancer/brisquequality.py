...
if sys.version_info[0] < 3:
    ...
    import svmutil
    from svmutil import *
    from home.ahmed.PycharmProjects.Lung_Cancer.learnopencv.svm import *
else:
    # if python 3.x version 
    # make sure the file is in libsvm/python folder
    from learnopencv.ImageMetrics.Python.libsvm.python import svm
    from learnopencv.ImageMetrics.Python.libsvm.python import svmutil
    from learnopencv.ImageMetrics.Python.libsvm.python.svm import *
    from learnopencv.ImageMetrics.Python.libsvm.python.svmutil import *
...
def test_measure_BRISQUE(imgPath):
    ...
    # load model 
    model = svmutil.svm_load_model("/home/ahmed/PycharmProjects/Brisque/learnopencv/ImageMetrics/Python/libsvm/python/allmodel")
...
"""
"""
img_path= "/home/ahmed/PycharmProjects/Brisque/Train_dir/A/A0178/1-026_139.png"
# calculate quality score
qualityscore = test_measure_BRISQUE(img_path)#sys.argv[1])
